...
void initialize_game(void)
{
    ...
    strcpy(questions[1].answer, "Shrek");
    ...
    strcpy(questions[3].answer, "Rango");
    ...
    strcpy(questions[4].answer, "Zootopia");
    ...
    strcpy(questions[5].answer, "Kangaroo");
    ...
    strcpy(questions[7].answer, "Octopus");
    ...
    strcpy(questions[8].answer, "Turtle");
    ...
    strcpy(questions[9].answer, "Motorcycle");
    ...
    strcpy(questions[10].answer, "Ambulance");
    ...
    strcpy(questions[11].answer, "Airplane");
    ...
    strcpy(questions[12].answer, "Tractor");
    ...
    strcpy(questions[13].answer, "Doctor");
    ...
    strcpy(questions[14].answer, "Chef");
    ...
    strcpy(questions[15].answer, "Architect");
    ...
    strcpy(questions[16].answer, "Chiropractor");
