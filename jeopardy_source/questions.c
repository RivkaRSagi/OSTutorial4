...
void initialize_game(void) {
  ...
  strcpy(questions[4].question, "It has very muscular arms and carries its "
                                "children in a pouch on its stomach");
  ...
  strcpy(questions[5].question,
         "It's nocturnal, can turn its head 360 degrees, and brings Hogwarts "
         "students their acceptance letters");
  ...
  strcpy(questions[6].question,
         "It has 3 hearts and is said to be as intelligent as humans");
  ...
  strcpy(questions[7].question,
         "It is very slow on land, but can be very fast in the water. It is "
         "protected by a hard shell on its back.");
  ...
  strcpy(questions[8].question, "It has two wheels and is very loud, you need "
                                "a special license to drive it");
  ...
  strcpy(questions[9].question,
         "It is used to rush injured people to hospitals in an emergency");
  ...
  strcpy(questions[10].question,
         "It is used to fly people from one place to another, can be expensive "
  ...
  strcpy(questions[11].question,
         "Used on farms to assist with agricultural tasks");
  ...
  strcpy(questions[12].question,
         "They diagnose you and prescribe you medicine when you are sick");
...
void display_categories(void) {
  printf("\033[35mCategories: %s, %s, %s, %s\n\033[0m", questions[0].category,
         questions[4].category, questions[8].category, questions[12].category);

  for (int j = 0; j < 4; j++) {
    for (int i = 0; i < 16; i += 4) {
      if (!questions[i + j].answered)
        printf("\033[1;31m[\033[0;33m%d\033[1;31m]\033[0m   ",
               questions[i + j].value);
      else
